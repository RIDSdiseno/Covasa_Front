...
type WorkerDraft = Omit<Worker, 'id'>
...
const initialWorkers: Worker[] = [
  ...
  },
  {
    ...
    nombre: 'Luis Perez',
    cargo: 'Bodega',
    email: 'lperez@covasa.cl',
    telefono: '+56 2 2456 7711',
    estado: 'Inactivo',
  },
]
...
function createId() {
  return `wrk-${Math.random().toString(36).slice(2, 10)}`
}

export default function TrabajadoresPage() {
  const [items, setItems] = useState<Worker[]>(initialWorkers)
